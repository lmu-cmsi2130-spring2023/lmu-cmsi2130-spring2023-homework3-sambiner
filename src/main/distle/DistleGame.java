...
public class DistleGame {
     ...
     *                       composing all possible words that may be selected as
     *                       the secret answers.
     * @param verbose        Boolean flag that can be set to true to see all of the
     *                       game's mechanics
     *                       printed out, false otherwise.
     * @param ai             Pass in a new DistlePlayer object to have it play the
     *                       game; otherwise, leave
     *                       null to play as human.
     * @param seed           A numerical seed for the random number generator that
    ...
    /**
     * See
     * {@link #DistleGame(String dictionaryPath, boolean verbose, DistlePlayer ai, int seed)}.
     * This version does
     * not specify a random seed, which means that each time it is run, a new set of
     * secret words will be selected
    ...
    /**
     * Begins a new game of Distle with the specified word as the secret, and the
     * given number
    ...
    /**
     * See {@link #newGame(String word, int maxGuesses)}. This method serves the
     * same purpose
     * except that a random word will be selected as opposed to being hand-picked as
     * an argument.
     */
    ...
    /**
     * Getter for whether or not the player won a game after it has reached a
     * conclusion.
     * 
    ...
    /**
     * The main workhorse method of a newly started DistleGame that sequentially
     * selects / sets
     * a secret word, resets fields, asks the player for guesses, and manages the
     * game logic / hints.
     * 
    ...
    /**
     * Requests a guess from the player of this DistleGame. If a human, accepts
     * their answer via
